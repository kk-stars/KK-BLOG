<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"G:\PHPWAMP_IN2\wwwroot\kk-blog/application/index\view\article\article.html";i:1528942820;s:72:"G:\PHPWAMP_IN2\wwwroot\kk-blog/application/index\view\Public\header.html";i:1527503171;s:71:"G:\PHPWAMP_IN2\wwwroot\kk-blog/application/index\view\Public\right.html";i:1531727110;s:72:"G:\PHPWAMP_IN2\wwwroot\kk-blog/application/index\view\Public\footer.html";i:1524903142;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>学无止尽 — <?php echo $conf['title']; ?></title>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    <div class="container">
        ...
        <span class="c-gray en">&gt;</span> 栏目云
        <span class="c-gray en">&gt;</span> <span class="c-gray"><i class="Hui-iconfont">&#xe64b;</i> <?php echo $cateName; ?></span>
        <?php else: ?>
        <span class="c-gray en">&gt;</span> 学无止境
        <?php endif; ?>
    </div>
</nav>
