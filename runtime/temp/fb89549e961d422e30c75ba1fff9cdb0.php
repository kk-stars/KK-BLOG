<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\comment\comment.html";i:1548135844;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\header.html";i:1548062421;s:77:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\aside.html";i:1548137762;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\prompt.html";i:1545573305;s:76:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\info.html";i:1548061883;s:83:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\loginRecord.html";i:1548063034;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            <form action="" method="post">
                ...
                <div class="table-responsive" id="responsive">
                    <table class="table table-striped table-hover">
                        <thead>
                        <tr>
                            <th width="80px"><span class="glyphicon glyphicon-th-large"></span> <span
                                    class="visible-lg">ID</span></th>
                            <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">评论内容</span></th>
                            <th width="400px"><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">评论文章</span></th>
                            <th width="200px"><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">评论者</span></th>
                            <th width="180px"><span class="glyphicon glyphicon-time"></span> <span
                        ...
                        <tr id="cid_<?php echo $c['commentId']; ?>">
                            <td style="text-align: center;"><?php echo $c['commentId']; ?></td>
                            <td class="article-title"><?php echo mb_substr($c['commentContent'],0,40,'utf-8'); if(strlen($c['commentContent']) >
                                152){echo " ……";} ?>
                            </td>
                            <td class="article-title"><?php echo mb_substr($c['articleTitle'],0,25,'utf-8'); if(strlen($c['articleTitle']) >
                                100){echo " ……";} ?>
                            </td>
                            <td class="article-title"><?php echo $c['randAtorName']; ?></td>
                        ...
                        <tr height="80px">
                            <td colspan="6">
                                <div class="pagelist"><?php echo $comment->render(); ?></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
