<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\mood\mood.html";i:1548054074;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\header.html";i:1545573305;s:77:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\aside.html";i:1548053658;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\prompt.html";i:1545573305;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
            ...
            <tbody>
            	<?php if(is_array($mood) || $mood instanceof \think\Collection || $mood instanceof \think\Paginator): $i = 0; $__LIST__ = $mood;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
	              <tr height = '87px' id="mid_<?php echo $m['moodId']; ?>">
	                <td style="text-align: center;"><?php echo $m['moodId']; ?></td>
