<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\log\log.html";i:1548052223;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\header.html";i:1545573305;s:77:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\aside.html";i:1548053658;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\prompt.html";i:1545573305;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php if(is_array($op) || $op instanceof \think\Collection || $op instanceof \think\Paginator): $i = 0; $__LIST__ = $op;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?>
                            <tr id="operation_tr_<?php echo $o['id']; ?>">
                                ...
                                <td class="article-title"><?php echo $o['op_city']; ?></td>
