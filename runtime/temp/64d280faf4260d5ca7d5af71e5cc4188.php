<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/index\view\board\board.html";i:1548128374;s:72:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/index\view\Public\header.html";i:1547368745;s:72:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/index\view\Public\footer.html";i:1545573305;}*/ ?>
<!DOCTYPE HTML>
<html>
    ...
    <div class="col-xs-12 col-md-10 col-md-offset-1 mt-20">
            ...
            <div style="background: #e1e2e9;">
                ...
                <p style="text-align: center;">
					<span style="font-size: 16px; font-family: NSimSun;"><strong>都可以联系
							&nbsp;</strong></span><span style="font-size: 16px; font-family: NSimSun;"><strong>℡ <?php echo $conf['userName']; ?>
        ...
        <div class="commentAll">
            ...
            <div class="reviewArea clearfix">
                <?php if($conf['message'] == '1'): ?>
                    <textarea id="commentTextarea" class="comment-content comment-input" placeholder="请输入留言&hellip;" onkeyup="keyUP(this)"></textarea>
                    <a href="javascript:;" class="plBtn" onclick="submitComment()">留言</a>
                <?php else: ?>
                    <textarea id="commentTextarea" class="comment-content comment-input" placeholder="留言系统正在维护中&hellip;" style="pointer-events:none;background: #e1e2e9;"></textarea>
                    <a href="javascript:;" style="pointer-events:none;background: #e1e2e9;" class="plBtn">留言</a>
                <?php endif; ?>
            </div>
            <!--评论区域 end-->
            <!--回复区域 begin-->
                    ...
                    <div class="comment-show-con-list pull-left clearfix">
                        ...
                        <div class="hf-list-con" style="display: block;">
                            ...
                            <div class="all-pl-con">
                                ...
                                <div class="date-dz">
                                    <span class="date-dz-left pull-left comment-time"><?php echo $mr['replyTime']; ?></span>
                                </div>
                            </div>
