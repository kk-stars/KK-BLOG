        ...
        window.onload=function () {
                ...
                ajax('get' , '__URL__/flow' , 'page=' + iPage , function (data) {
                    ...
                    for (var i = 0 ; i < d.data.length ; i++){
                        ...
                        if(d.data[i].articlePic == '' || d.data[i].articlePic == null){
                            ...
                            var html = "<li class='index_arc_item no_pic'><h4 class='title'><a href='article?aid=" + d.data[i].articleId + "'>" + d.data[i].articleTitle + "</a></h4><div class='date_hits'><span>" + d.data[i].ator + "</span><span>" + d.data[i].addTime.substr(0,10) + "</span><span><a href='cate?cid=" + d.data[i].cateId + "'>" + d.data[i].cateName + "</a></span><p class='hits'><i class='Hui-iconfont' title='点击量'>&#xe6c1;</i> " + d.data[i].articleClicks + " °</p><p class='commonts'><i class='Hui-iconfont' title='评论'>&#xe622;</i><span id='sourceId::105' class='cy_cmt_count'>" + d.data[i].praiseClicks + "</span></p></div><div class='desc'>" + contt + "</div></li>";

                        }else{

                            var html = "<li class='index_arc_item'><a href='article?aid=" + d.data[i].articleId + "' class='pic'><img class='lazyload' src='__PUBLIC__" + d.data[i].articlePic + "' data-original='__PUBLIC__" + d.data[i].articlePic + "' alt='" + d.data[i].articleTitle + "'></a><h4 class='title'><a href='article?aid=" + d.data[i].articleId + "'>" + d.data[i].articleTitle + "</a></h4><div class='date_hits'><span>" + d.data[i].ator + "</span><span>" + d.data[i].addTime.substr(0,10) + "</span><span><a href='cate?cid=" + d.data[i].cateId + "'>" + d.data[i].cateName + "</a></span><p class='hits'><i class='Hui-iconfont' title='点击量'></i> " + d.data[i].articleClicks + " ° </p><p class='commonts'><i class='Hui-iconfont' title=''></i> <span class='cy_cmt_count'>" + d.data[i].praiseClicks + "</span></p></div><div class='desc'>" + contt + "</div></li>";
                        }
            ...
            load.onclick = function(){
                ...
                if(b){
                    b = false;
                    iPage++;
                    window.setTimeout(function(){getLi()},1500);//这里 getLi() 要写成 function(){ getLi() }
                }
            }
        }
