<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\cate\caterecovery.html";i:1548050608;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\header.html";i:1545573305;s:77:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\aside.html";i:1545573305;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\prompt.html";i:1545573305;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-header">回收站 <span class="badge"><?php echo $count; ?></span></h1>
            ...
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th width="200px"><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">文章数</span></th>
              ...
              <tbody>
              	<?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
	                <tr id="cid_<?php echo $c['cateId']; ?>">
	                  ...
	                  <td>
	                  	<a href="<?php echo url('cate/cateRecoveryUp',array('cateId' => $c['cateId'])); ?>">还原　</a>
	                  	<a rel="1" href="javascript:;" onclick="delCate(<?php echo $c['cateId']; ?>)">彻底删除</a>
	                  </td>
	                </tr>
...
<script>
    ...
    function delCate(cateId){
        var c = confirm('确定要彻底删除吗?(包括此栏目下的文章及子栏目)');
        if(c == true){
