<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\message\replymessage.html";i:1548140195;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\header.html";i:1548062421;s:77:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\aside.html";i:1548137762;s:78:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\prompt.html";i:1545573305;s:76:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\info.html";i:1548061883;s:83:"D:\PHPWAMP_IN3\wwwroot\kkstars/application/babysbreath\view\Public\loginRecord.html";i:1548063034;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
      ...
      <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="" method="post">
                <h1 class="page-header">管理 <span class="badge"><?php echo $rmCount; ?></span></h1>
                <div class="table-responsive" id="responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th width="100px"><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">回复人</span></th>
                        ...
                        <tbody>
                        <?php if(is_array($replyMessage) || $replyMessage instanceof \think\Collection || $replyMessage instanceof \think\Paginator): $i = 0; $__LIST__ = $replyMessage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
                        <tr id="mid_<?php echo $m['replyMid']; ?>">
                            <td style="text-align: center;"><?php echo $m['replyMid']; ?>
                            </td>
                            <td class="article-title">
                                <?php echo mb_strlen( $m['replyContent'] , 'utf-8' ) > 40 ? mb_substr(
                                $m['replyContent'] , 0 , 40 , 'utf-8' ) . '...' : $m['replyContent']; ?>
                            </td>
                            <td class="article-title"><?php echo $m['ator']; ?></td>
                            <td><?php echo $m['replyTime']; ?></td>
                            <td><a id="seeComment" href="javascript:;" onClick="seeComment(<?php echo $m['replyId']; ?>)">
                                <i class="fa fa-eye"></i> 查看</a> 　
                                <a id="del" href="javascript:;" onClick="delComment(<?php echo $m['replyId']; ?>)">
                        ...
                        <tr height="80px">
                            <td colspan="6">
                                <div class="pagelist"><?php echo $replyMessage->render(); ?></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<div class="modal fade" id="comment" tabindex="-1" role="dialog" aria-labelledby="messageModalLabel" aria-hidden="true">
...
<script>
    ...
    function seeComment(messageId) {
        ...
        $.post('__URL__/seeReplyMessage', {'messageId': messageId}, function (data) {
            var d = JSON.parse(data);/*	 JSON.parse 解析JSON字符串 。将一个 JSON 字符串转换为对象。 */
            if (d.code == 1) {
                $('#cmContent').html(d.message.replyContent);
                $('#cmArticle').html(d.message.messageContent);
    ...
    function delComment(messageId) {
        ...
        if (c == true) {
            $.post('__URL__/delReplyMessage', {'messageId': messageId}, function (data) {
                var d = JSON.parse(data);
                if (d.code == 1) {
