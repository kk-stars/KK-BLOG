          ...
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content" style="    height: 55px;">
                ...
                <input type="text" name="alias" style="width:33%;float:left; margin-left: 5px;" value="<?php echo $conf['alias']; ?>" class="form-control" placeholder="别名" autocomplete="off" title="别名"  />
